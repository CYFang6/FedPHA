...
class Transformer(nn.Module):
    def __init__(self, width: int, layers: int, heads: int, attn_mask: torch.Tensor = None, prompts_needed=0,
        ...
        if current_trainer == 'IVLP' or current_trainer == 'VPT':
            ...
            assert current_trainer in ['CLIP','BL_GL','PROMPTFL','PROMPTFL_PROX','GLTRANS','GL_ALI','GL_SVD','GL_SVDMSE','GL_SVDMSE_HE','GL_SVDCL','GL_SVDIM','GL_SVDTR','GLORTH_HE','GLORTH_HEGAN','GLORTH_HESVD','GLORTH_HEBASE','GLORTH_HESVDPJ','GLORTH_HESVDPJP','GLORTH_HESVDTA','GLORTH_HESVDA','GLORTH_HESVDAO','GLORTH_HESVDCOM','GLORTH_HESVDOR','GLORTH_UB','GLORTH','GLORTH_NOS','GLORTH_SQ','GLORTH_SQ_ONLY','GLORTH_ADD','GLP_OT','FEDPEFT','FEDPEFT_DePT','FEDPEFT_PEGO','FEDPEFT_PEGO_GA','FEDPGP','GLP_OT_V']
